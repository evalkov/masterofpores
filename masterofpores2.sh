...
# Software location and output where hard links will be created must be on the same filesystem.
 
basedir="/scratch/cluster_scratch/valkove2/master_of_pores_v2"
nextflow="/home/valkove2/soft/nextflow"
...
procdir="/scratch/cluster_scratch/valkove2/mop2"
...
outdir="/scratch/cluster_scratch/valkove2/"$timestamp"_master_of_pores_V2_"$project_name""
mkdir ${outdir}
